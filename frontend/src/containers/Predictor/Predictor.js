...
class Predictor extends Component {
  ...
  async componentDidMount() {
    ...
    try{
      const res = await axios.get(`${process.env.REACT_APP_ENDPOINT}/api/user/me`);
  ...
  onSubmit = async (e) => {
    ...
    try {
      let res = await axios.post(`${process.env.REACT_APP_ENDPOINT}/api/prediction`, formData);
  ...
  addBookHandler = async (e) => {
    ...
    try{
      await axios.post(`${process.env.REACT_APP_ENDPOINT}/api/books`, payload);
