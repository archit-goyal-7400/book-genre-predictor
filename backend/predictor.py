...
def main():
    a = read_in()
    m = joblib.load('./ML/model-data/model-2.pkl')

    xtrain = np.load('./ML/model-data/xtrain2.npy', allow_pickle=True)
    ...
    genre_data = np.load('./ML/model-data/genre_data2.npy', allow_pickle=True)
